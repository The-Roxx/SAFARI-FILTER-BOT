...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "Royal_X_RoxStar") # widout 👉 @
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'I_PapCornBeta')
...
# Streaming
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002245922111")
